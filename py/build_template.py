...
# 코트 기본값·사전채움 로스터는 클럽 사실이라 web/py/club_config.json에서 읽는다(단일 정본).
# '코트' 시트와 '씨드대진' 시트가 같은 COURTS_DEFAULT를 써야 레이아웃이 어긋나지 않는다.
from club_config import COURTS_DEFAULT, PREFILL_FROM_IMAGE  # noqa: E402
