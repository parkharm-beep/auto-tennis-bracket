...
PREFILL_FROM_IMAGE = [
    # 정회원 사전채움 로스터 — 26.8.2 사용자 확정본(테니스_입력양식_사전채움_25명.xlsx) 반영.
    # 정회원 25명 전원. 게스트는 매주 달라지므로 담지 않는다.
    # IN/OUT은 전원 07:00~12:00 기본(26.8.8~ 운동시간 07:00~12:00).
    # 예외: 이성돈(09:00~12:00, 최대 3게임), 원유철·이지은(08:00~11:00, 본업 수업).
    # (이름, 성별, 구력, 구분, IN, OUT, 최소게임수, 최대게임수, 메모)  단일 클럽이라 클럽 칸은 비워 둠.
    ("경성현", "남", 4,  "정회원", "07:00", "12:00", "", "", ""),
    ("김준학", "남", 10, "정회원", "07:00", "12:00", "", "", ""),
    ("김효순", "남", 5,  "정회원", "07:00", "12:00", "", "", ""),
    ...
    ("박진우", "남", 7,  "정회원", "07:00", "12:00", "", "", ""),
    ("서종수", "남", 5,  "정회원", "07:00", "12:00", "", "", ""),
    ("최종인", "남", 10, "정회원", "07:00", "12:00", "", "", ""),
    ("원유철", "남", 4,  "정회원", "08:00", "11:00", "", "", "본업 수업 — 08:00~11:00 참석"),
    ("이강진", "남", 4,  "정회원", "07:00", "12:00", "", "", ""),
...
def _build_guide_sheet(ws):
    ...
    lines = [
        ...
        ("", False),
        ("■ 2. 코트 시트 작성법", True),
        ("• 기본값: A코트=1번(07:00-12:00), B코트=2번(07:00-12:00), C코트=3번(07:00-09:00)", False),
        ("    - 2026.8.8부터 운동시간 07:00~12:00 (3번 코트는 07:00~09:00 그대로)", False),
