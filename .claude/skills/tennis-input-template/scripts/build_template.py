...
PREFILL_FROM_IMAGE = [
    # 정회원 사전채움 로스터 — 입력양식 편집본(21명) 반영: 김호순 성별 남, 박경수 3게임 상한, 정재동 제외.
    # (이름, 성별, 구력, 구분, IN, OUT, 최대게임수, 메모)  단일 클럽이라 클럽 칸은 비워 둠.
    ("경성현", "남", 3,  "정회원", "07:00", "10:00", "", ""),
    ("김준학", "남", 10, "정회원", "07:00", "12:00", "", ""),
    ("김호순", "남", 5,  "정회원", "08:00", "11:00", "", ""),
    ("남궁석", "남", 10, "정회원", "08:30", "12:00", "", ""),
    ("노남숙", "여", 3,  "정회원", "08:00", "12:00", "", ""),
    ("서명숙", "여", 5,  "정회원", "08:00", "12:00", "", ""),
    ("전혜선", "여", 7,  "정회원", "08:00", "12:00", "", ""),
    ("방미라", "여", 3,  "정회원", "08:00", "12:00", "", ""),
    ("박경수", "남", 5,  "정회원", "08:00", "12:00", 3, ""),
    ("민기준", "남", 4,  "정회원", "07:00", "12:00", "", ""),
    ("박진우", "남", 5,  "정회원", "08:00", "11:00", "", ""),
    ("서종수", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("신혁재", "남", 3,  "정회원", "08:00", "11:30", "", ""),
    ("원유철", "남", 3,  "정회원", "08:00", "11:00", "", ""),
    ("이강진", "남", 3,  "정회원", "07:00", "12:00", "", ""),
    ("이성돈", "남", 10, "정회원", "09:00", "12:00", 3, "이미지 메모: 3게임"),
    ("이성수", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("정진락", "남", 10, "정회원", "08:00", "12:00", "", ""),
    ("최종인", "남", 10, "정회원", "10:00", "12:00", 3, "이미지 메모: 3게임"),
    ("한병익", "남", 10, "정회원", "08:00", "12:00", "", ""),
    ("김도윤", "남", 5,  "정회원", "08:00", "12:00", "", "지난 로스터 유지(이번 주 이미지엔 없음)"),
]
...
def _build_guide_sheet(ws):
    ...
    lines = [
        ...
        ("• 혼합복식은 차선책. 다음 경우에만 나옵니다:", False),
        ("    ① 남자(또는 여자)가 4명이 안 되어 단성 복식 자체가 불가능", False),
        ("    ② 단성 복식을 더 짜면 '같은 4명이 상대편까지 똑같이' 다시 붙게 될 때", False),
        ("      예) 여자가 딱 4명이면 편 가르는 방법이 3가지뿐 → 여자복식은 3판이 한계.", False),
        ("      그 이상 뛰려면 완전히 같은 대진이 반복되므로, 모자란 게임수만큼만", False),
        ("      혼합복식(보통 1~2판)으로 채웁니다. 그 이상은 나오지 않습니다.", False),
        ...
        ("• 같은 4명이 상대편까지 그대로 다시 붙는 '완전 중복 대진'은 특히 회피", False),
        ("  (편만 바꿔 다시 만나는 것도 약하게 회피)", False),
