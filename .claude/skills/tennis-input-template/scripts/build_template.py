...
PREFILL_FROM_IMAGE = [
    # 정회원 사전채움 로스터 — 26.7.25 대진표 이미지 명단(21명) 반영.
    # 기존에 있던 사람은 이전 입력양식의 정보(성별·구력·구분·IN/OUT)를 그대로 유지하고,
    # 새로 들어온 사람은 성별·구력만 비워 둔다(노란 칸 = 직접 입력).
    # 명단 변경: 남궁석·민기준·최종인·김도윤 빠짐 / 정정희·김수찬·정재동·임성훈 새로 들어옴.
    # (이름, 성별, 구력, 구분, IN, OUT, 최대게임수, 메모)  단일 클럽이라 클럽 칸은 비워 둠.
    ("경성현", "남", 3,  "정회원", "07:00", "12:00", "", ""),
    ("김준학", "남", 10, "정회원", "07:00", "12:00", "", ""),
    ("김호순", "남", 5,  "정회원", "07:00", "12:00", "", "26.7.25 대진표엔 '김효순'으로 표기 — 동일인이면 그대로"),
    ("노남숙", "여", 3,  "정회원", "07:00", "12:00", "", ""),
    ("서명숙", "여", 5,  "정회원", "07:00", "12:00", "", ""),
    ("전혜선", "여", 7,  "정회원", "07:00", "12:00", "", ""),
    ("방미라", "여", 3,  "정회원", "07:00", "12:00", "", ""),
    ("정정희", "",  "",  "정회원", "07:00", "12:00", "", "신규 — 성별·구력 입력 필요"),
    ("박경수", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("박진우", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("서종수", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("신혁재", "남", 3,  "정회원", "07:00", "12:00", "", ""),
    ("원유철", "남", 3,  "정회원", "07:00", "12:00", "", ""),
    ("이강진", "남", 3,  "정회원", "07:00", "12:00", "", ""),
    ("이성돈", "남", 10, "정회원", "07:00", "12:00", "", ""),
    ("이성수", "남", 5,  "정회원", "07:00", "12:00", "", ""),
    ("정진락", "남", 10, "정회원", "07:00", "12:00", "", ""),
    ("한병익", "남", 10, "정회원", "07:00", "12:00", "", ""),
    ("김수찬", "",  "",  "정회원", "07:00", "12:00", "", "신규 — 성별·구력 입력 필요"),
    ("정재동", "",  "",  "정회원", "07:00", "12:00", "", "신규 — 성별·구력 입력 필요"),
    ("임성훈", "",  "",  "정회원", "07:00", "12:00", "", "신규 — 성별·구력 입력 필요"),
]
...
def _build_guide_sheet(ws):
    ...
    lines = [
        ...
        ("      그 이상 뛰려면 완전히 같은 대진이 반복되므로, 모자란 게임수만큼", False),
        ("      혼합복식으로 채웁니다. 그 이상은 나오지 않습니다.", False),
