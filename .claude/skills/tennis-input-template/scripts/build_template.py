...
def _build_guide_sheet(ws):
    ...
    lines = [
        ...
        ("  붙는 게 아니고 ③ 두 팀 구력 합 차이가 3 이내.", False),
        ("    예) 방미라(3)+노남숙(3)=6  vs  서명숙(5)+정정희(5)=10 은 구력 합 4 차이라", False),
        ("        재미가 없다고 보고 이런 조합은 만들지 않습니다.", False),
        ...
        ("• 합산 구력 차이가 3을 넘으면 강하게 회피 — 그렇게 될 바에는 다른 조합이나", False),
