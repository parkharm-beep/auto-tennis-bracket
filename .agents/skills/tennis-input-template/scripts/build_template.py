...
PREFILL_FROM_IMAGE = [
    # 정회원 사전채움 로스터 — 26.8.1 사용자 제공 입력양식(바탕화면 테니스_입력양식_사전채움.xlsx) 반영.
    # 게스트(권명숙·임승재·백용승)는 매주 달라지므로 정회원만 담는다. IN/OUT은 각자의 평소 시간대.
    # 명단 변경: 전혜선·방미라·신혁재·한병익·김수찬·정재동 빠짐 / 이지은·최종인·민기준 새로 들어옴.
    # 이름 정정: 김호순 → 김효순.
    # (이름, 성별, 구력, 구분, IN, OUT, 최소게임수, 최대게임수, 메모)  단일 클럽이라 클럽 칸은 비워 둠.
    ("경성현", "남", 3,  "정회원", "07:00", "12:00", "", "", ""),
    ("김준학", "남", 10, "정회원", "07:00", "12:00", "", "", ""),
    ("김효순", "남", 5,  "정회원", "08:00", "11:00", "", "", ""),
    ("노남숙", "여", 3,  "정회원", "08:00", "12:00", "", "", ""),
    ("서명숙", "여", 5,  "정회원", "08:00", "12:00", "", "", ""),
    ("이지은", "여", 3,  "정회원", "08:00", "11:00", "", 3, ""),
    ("정정희", "여", 5,  "정회원", "08:00", "12:00", "", "", ""),
    ("박경수", "남", 5,  "정회원", "08:00", "12:00", "", "", ""),
    ("박진우", "남", 5,  "정회원", "08:00", "11:00", "", "", ""),
    ("서종수", "남", 5,  "정회원", "07:00", "12:00", "", "", ""),
    ("최종인", "남", 10, "정회원", "08:00", "12:00", "", "", ""),
    ("원유철", "남", 3,  "정회원", "08:00", "11:00", "", "", ""),
    ("이강진", "남", 3,  "정회원", "07:00", "11:00", "", "", ""),
    ("이성돈", "남", 10, "정회원", "09:00", "12:00", "", 3, ""),
    ("이성수", "남", 5,  "정회원", "07:00", "12:00", "", "", ""),
    ("정진락", "남", 10, "정회원", "08:00", "12:00", "", "", ""),
    ("민기준", "남", 4,  "정회원", "07:00", "11:00", "", "", ""),
    ("임성훈", "남", 5,  "정회원", "08:00", "12:00", "", "", ""),
]
...
def _build_players_sheet(ws, prefill: str = ""):
    ...
    for r in range(2, 32):
        ...
        if idx < len(prefill_rows):
            name, gender, exp, mem, in_t, out_t, min_g, max_g, memo = prefill_rows[idx]
